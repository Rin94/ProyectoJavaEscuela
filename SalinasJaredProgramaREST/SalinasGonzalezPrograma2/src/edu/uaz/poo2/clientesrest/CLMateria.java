 ...
 * USAGE:
 * <pre>
 *        CLMateria client = new CLMateria();
...
public class CLMateria {
    ...
    public <T> T obtenNombreMateria_JSON(Class<T> responseType, String claveCarrera) throws ClientErrorException {
    ...
    public void remove(String id) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("eliminamateria/{0}", new Object[]{id})).request().delete();
    }
    ...
    public void edit_XML(Object requestEntity, String id) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("modificamateria/{0}", new Object[]{id})).request(javax.ws.rs.core.MediaType.APPLICATION_XML).put(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_XML));
    }
    ...
    public void create_XML(Object requestEntity) throws ClientErrorException {
        webTarget.path("agregarmateria").request(javax.ws.rs.core.MediaType.APPLICATION_XML).post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_XML));
    }
