    ...
    public void remove(@PathParam("id") String id) {
        try {
           /*
              ...
              getEntityManager().createQuery("DELETE FROM Materia m WHERE m.claveCarrera =:clave")
                      .setParameter("clave", id).executeUpdate();
            ...
            System.out.println("Paso algo raro: "+e.getMessage());
        }
