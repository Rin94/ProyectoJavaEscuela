...
public class GUIControlEscolar extends javax.swing.JFrame {
    ...
    private void inicializaEstudiantes() {
        ...
        List<Estudiante> datos = conector.obtenEstudiante();
    ...
    /**
     * Clase que hace que los JTF que usen numeros no se puedan introducir otros caracteres 
     * que no son numeros
     */
    ...
    private class ManejadorComboPeriodos implements ItemListener {
        ...
        /**
         * Metodo de interfaz IntemListener para manejar los el combo de Periodos
         *
         * @param e evento
         */
        @Override
    ...
    /**
     * Clase interna que maneja la lista del tab de Carreras
     *
     */
    ...
    private class ManejadorBotonesCarrera implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (origen == jBotonNuevaCarrera) {
                ...
                if (conector.modificarCarrera(c)) {
    ...
    private class ManejadorBotonesMateria implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (origen == jBotonNuevaMateria) {
                ...
                if (conector.modificarMateria(m)) {
    ...
    private class ManejadorBotonesPeriodo implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (origen == jBotonNuevoPeriodo) {
                ...
                if (ano < 2000 || ano > 2014) {

                    JOptionPane.showMessageDialog(null,
                            bundle.getString("textoConfirmacionAñoPeriodo"),
                            bundle.getString("tituloConfirmacionAñoPeriodo"), WIDTH);

                } else {
                     boolean agregar=true;
                    if (agregar==conector.modificarPeriodo(m)) {
                        ...
                        JOptionPane.showMessageDialog(null,
                            bundle.getString("tituloError"),
                            bundle.getString("errorModificarPeriodo"), WIDTH);
            ...
            if (origen == jBotonAgregarPeriodo) {
                ...
                if (ano < 2000 || ano > 2014) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            bundle.getString("tituloConfirmacionAñoPeriodo"),
                            bundle.getString("textoConfirmacionAñoPeriodo"), WIDTH);
                    ...
                    if (agregar==conector.agregaPeriodo(m)) {
                        ...
                        JOptionPane.showMessageDialog(null,
                            bundle.getString("tituloError"),
                            bundle.getString("errorAgregarPeriodo"), WIDTH);
    ...
    private class ManejadorBotonesEstudiante implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (origen == jBotonNuevoEstudiante) {
                ...
                if (conector.modificarEstudiante(m) == consulta) {
    ...
    private class ManejadorBotonesCargaEstudiante implements ActionListener {
        ...
        private CargaEstudiante obtenDatos() {
            ...
            if (indicePeriodo != -1) {
                periodoEscolar = modeloComboPeriodoEstudiante.getElementAt(indicePeriodo++);
            ...
            if (indiceMateria != -1) {
                materia = modeloComboMateriaEstudiante.getElementAt(indiceMateria++);
            ...
            if(claveMateria!=null&&idPeriodo!=null){
                try {
                    ...
                    conector.obtenSigIdCargaEstudiante(), matricula, claveMateria, idPeriodo);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (origen == jBotonEliminaCargaEstudiante) {
                ...
                if(carga!=null){
                    if (
                        conector.agregaCargaEstudiante(carga) == consulta) {
    ...
    private void inicializaCarreras() {
        ...
        List<Carrera> datos = conector.obtenCarrera();//conseguimos la lista
        for (Carrera c : datos) {
            modeloListaCarreras.addElement(c);
            modeloComboCarreraEstudiante.addElement(c);
        }
    ...
    /**
     * Muestra la informacion de las Materias asi como la lista del panel de Materias
     */
    private void inicializaMaterias() {
        ...
        List<Materia> datos = conector.obtenMateria();
        List<Carrera> dat = conector.obtenCarrera();
        for (Materia m : datos) {
            modeloListaMateria.addElement(m);
            modeloComboMateriaEstudiante.addElement(m);
    ...
    private void inicializaPeriodos() {
        ...
        List<PeriodoEscolar> datos = conector.obtenPeriodo();
        //SortedSet<String>dat=conector.periodo();
        List<Short> dat = conector.periodoBox();
        jTFIdPeriodoEscolar.setEditable(false);
        jBotonAgregarPeriodo.setVisible(false);
        ...
        for (short c : dat) {
            ...
            if (c == 1) {
                estacion = conector.obtenPeriodoString(c);
    ...
    /**
     * Clase interna para delimitar el n˙mero de caracteres en un jTextField
     */
    ...
    /**
     * Creates new form GUIControlEscolar
     */
        ...
        jPanelMateriasLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelMateriasLayout.createSequentialGroup()
                ...
                .addGroup(jPanelMateriasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jBotonModificarMateria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jBotonEliminarMateria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jBotonNuevaMateria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    ...
                    .addGroup(jPanelDetalleCargaEstudianteLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelDetalleCargaEstudianteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelDetalleCargaEstudianteLayout.createSequentialGroup()
                                ...
                                .addGroup(jPanelDetalleCargaEstudianteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanelDetalleCargaEstudianteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
